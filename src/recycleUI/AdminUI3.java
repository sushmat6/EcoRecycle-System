...
import recycle.OperationalStatus;
...
public class AdminUI3 extends javax.swing.JFrame {
        ...
        gl_funcPanel.setVerticalGroup(
                gl_funcPanel.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_funcPanel.createSequentialGroup()
                                ...
                                .addGap(30)
                                .addComponent(stat_btn, GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
                                .addGap(87)
        ...
        rcm_list.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                ...
                for (int i = 0; i < rcmList.size(); i++)
                {
                    ...
                    {
                        int noOfItems = rcmList.get(i).getNumberOfItems();
    ...
    private void stat_btnActionPerformed(java.awt.event.ActionEvent evt) {
